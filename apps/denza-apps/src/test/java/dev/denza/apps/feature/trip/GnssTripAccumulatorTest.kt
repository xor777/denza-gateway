...
class GnssTripAccumulatorTest {
    ...
    fun accumulatesDistanceOnlyWhileMoving() {
        ...
        acc.onFix(55.0, 37.0, 100.0, true, 0.0, false, 10.0, 0.0, 0.0)
        acc.onFix(55.0, 37.001, 100.0, true, 0.0, false, 10.0, 1.0, 1.0)
        ...
        acc.onFix(55.0, 37.010, 100.0, true, 0.0, false, 0.0, 2.0, 1.0)
    ...
    fun accumulatesPositiveClimbAndSmoothsAltitude() {
        ...
        repeat(30) { i ->
            acc.onFix(55.0, 37.0 + i * 0.0001, 100.0 + (i + 1) * 10.0, true, 0.0, false, 10.0, (i + 1).toDouble(), 1.0)
    ...
    fun variometerGoesNegativeOnDescent() {
        val acc = GnssTripAccumulator()
        acc.onFix(55.0, 37.0, 500.0, true, 0.0, false, 10.0, 0.0, 0.0)
        repeat(20) { i ->
            acc.onFix(55.0, 37.0, 500.0 - (i + 1) * 8.0, true, 0.0, false, 10.0, (i + 1).toDouble(), 1.0)
        }
        assertTrue("vario=${acc.variometer}", acc.variometer < 0.0)
    }
    ...
    fun stopLongerThanFifteenMinutesCrossesExactlyOnce() {
        ...
        repeat(200) {
            elapsed += 5.0
            if (acc.onFix(55.0, 37.0, 100.0, true, 0.0, false, 0.0, elapsed, 5.0)) crossings++
        }
